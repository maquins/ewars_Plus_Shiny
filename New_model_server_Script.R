...
#var_names_New_model <- eventReactive(
  ...
  #c(input$dat_new_Model,
    #input$shape_file_new_Model),{           
      ...
      ewars_Plus_DB_files<-readRDS("ewars_Plus_DB_files.rds")
      
      #data<-get_D_ata(inFile$datapath)
      data<-ewars_Plus_DB_files$original_Input_data
      vars_in_Model<-ewars_Plus_DB_files$alarm_indicators
      #all_endemic<-ewars_Plus_DB_files$all_endemic
      ...
      list(vars=names(data),dat=data,dists=dist,SHP=ewars_Plus_DB_files$shape_file,
           vars_in_Model=vars_in_Model,
           all_endemic=ewars_Plus_DB_files$all_endemic,
           other_alarm_indicators=ewars_Plus_DB_files$other_covariates,
           nlags=ewars_Plus_DB_files$nlags)
