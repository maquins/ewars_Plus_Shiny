...
observeEvent(c(input$new_model_Year_plot,
               ...
               input$alarm_indicators_New_model),
             {
               ...
               if(is.null(input$new_model_Week_plot_spat)){
                 new_model_Week_plot_spat<-35
               }else{
                 new_model_Week_plot_spat<-input$new_model_Week_plot_spat
...
observeEvent(eval(parse(text=paste0('c(',paste0(Out.Mod()$for_obs,collapse =','),')'))),{
  ...
  alarm_vars_lag<-Out.Mod()$alarm_vars
  ...
  alarm.indicators<-Out.Mod()$alarm_vars
